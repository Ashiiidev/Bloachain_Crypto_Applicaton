...
async  loadWeb3(){
   if(window.etherium)  {
     ...
     window.alert('Non-Etherium browser detected. You shuld consider trying MetaMask!')
   }
 ...
 if(this.state.loading) {
      content = <h3 id="loader" className=" text-danger  text-center">PLEASE WAIT ....</h3>
    } else{
      content = <Main
    ...
    return (
      <div>
   <Navbar account={this.state.account} man="ashish"/>
